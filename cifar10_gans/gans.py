...
load_epoch = 951  # Decide which epoch to reload weight, please check your file name
...
if __name__ == '__main__':
    ...
    for epoch in range(nb_epochs): #"""nb_epochs"""
        ...
        #print("LOOK HERE", generated_images.shape)
        np.save('cifar_image_data_{0:03d}'.format(load_epoch), generated_images)
